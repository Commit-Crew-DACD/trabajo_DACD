...
public class RecommendationService {
    ...
    public synchronized void rebuildRecommendations() {
        ...
        System.out.println("Canonical events: " + events.size());
    ...
    private boolean isValidEvent(Event event) {
        try {
            ...
            System.out.println("Skipping event with invalid date/time: " + event.getName());
            return false;
        }
    }
    ...
    private int representativeScore(Event event) {
        ...
        if (name.equals(normalize(extractArtistName(event.getName())))) {
            score += 4;
        }
    ...
    private String extractArtistName(String name) {
        String cleanedName = stripEventDecorators(name);
    ...
    private String stripEventDecorators(String name) {
